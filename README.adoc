...
[TIP]
A better, single-page version of this README can be found at https://jonaspammer.github.io/ansible-role-bootstrap[
jonaspammer.github.io/ansible-role-bootstrap].
