...
[NOTE]
Not to confuse:
Although some pre-commit hooks may be able to warn you about script-analyzed flaws in syntax or even code to some extend,
it does not run any real Test Suites.
...
To run the tests, simply issue `tox` on the command line.
