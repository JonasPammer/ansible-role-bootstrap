...
Though,
one may inform himself about the required development environment and its procedures
by looking at the devcontainer definition (and the CI configuration).
=====
